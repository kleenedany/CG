...
(function HierarchyInput$Members () {
  ...
  var $T12 = function () {
    return ($T12 = JSIL.Memoize($asm0E.System.Boolean)) ();
  };
  var $T13 = function () {
    return ($T13 = JSIL.Memoize($asm03.Fusee.Engine.Common.KeyCodes)) ();
  };
  var $T14 = function () {
  ...
  function HierarchyInput_CreateScene () {
    ...
    expr_112.Rotation = $S00().Construct(0.2, 0, 0);
    ...
    expr_16B.Rotation = $S00().Construct(0, 0, 0);
    expr_16B.Scale = $S00().Construct(1, 1, 1);
    expr_16B.Translation = $S00().Construct(0, 8, -0.5);
    this._greifarm1Transform = expr_16B;
    var expr_1C4 = new ($T01())();
    expr_1C4.Rotation = $S00().Construct(0, 0, 0);
    expr_1C4.Scale = $S00().Construct(1, 1, 1);
    expr_1C4.Translation = $S00().Construct(0, 8, 0.5);
    this._greifarm2Transform = expr_1C4;
    var expr_21C = new ($T03())();
    var expr_222 = $S01().Construct();
    var expr_228 = new ($T05())();
    var expr_22E = $S02().Construct();
    $S03().CallVirtual("Add", null, expr_22E, this._baseTransform);
    var expr_241 = new ($T07())();
    var expr_247 = new ($T08())();
    expr_247.Color = $S00().Construct(0.7, 0.7, 0.7);
    expr_241.Diffuse = expr_247;
    var expr_26C = new ($T09())();
    expr_26C.Color = $S00().Construct(1, 1, 1);
    expr_26C.Shininess = 5;
    expr_241.Specular = expr_26C;
    $S03().CallVirtual("Add", null, expr_22E, expr_241);
    $S03().CallVirtual("Add", null, expr_22E, $T0A().CreateCuboid($S00().Construct(10, 2, 10)));
    expr_228.Components = expr_22E;
    $S04().CallVirtual("Add", null, expr_222, expr_228);
    var expr_2CD = new ($T05())();
    var expr_2D3 = $S02().Construct();
    $S03().CallVirtual("Add", null, expr_2D3, this._bodyTransform);
    var expr_2E6 = new ($T07())();
    var expr_2EC = new ($T08())();
    expr_2EC.Color = $S00().Construct(1, 0, 0);
    expr_2E6.Diffuse = expr_2EC;
    var expr_311 = new ($T09())();
    expr_311.Color = $S00().Construct(1, 1, 1);
    expr_311.Shininess = 5;
    expr_2E6.Specular = expr_311;
    $S03().CallVirtual("Add", null, expr_2D3, expr_2E6);
    $S03().CallVirtual("Add", null, expr_2D3, $T0A().CreateCuboid($S00().Construct(2, 10, 2)));
    expr_2CD.Components = expr_2D3;
    var expr_36C = $S01().Construct();
    var expr_372 = new ($T05())();
    var expr_378 = $S02().Construct();
    $S03().CallVirtual("Add", null, expr_378, this._upperArmTransform);
    expr_372.Components = expr_378;
    var expr_390 = $S01().Construct();
    var expr_396 = new ($T05())();
    var expr_39C = $S02().Construct();
    var expr_3A2 = new ($T01())();
    expr_3A2.Rotation = $S00().Construct(0, 0, 0);
    expr_3A2.Scale = $S00().Construct(1, 1, 1);
    expr_3A2.Translation = $S00().Construct(0, 4, 0);
    $S03().CallVirtual("Add", null, expr_39C, expr_3A2);
    var expr_3FC = new ($T07())();
    var expr_402 = new ($T08())();
    expr_402.Color = $S00().Construct(0, 1, 0);
    expr_3FC.Diffuse = expr_402;
    var expr_427 = new ($T09())();
    expr_427.Color = $S00().Construct(1, 1, 1);
    expr_427.Shininess = 5;
    expr_3FC.Specular = expr_427;
    $S03().CallVirtual("Add", null, expr_39C, expr_3FC);
    $S03().CallVirtual("Add", null, expr_39C, $T0A().CreateCuboid($S00().Construct(2, 10, 2)));
    expr_396.Components = expr_39C;
    $S04().CallVirtual("Add", null, expr_390, expr_396);
    var expr_488 = new ($T05())();
    var expr_48E = $S02().Construct();
    $S03().CallVirtual("Add", null, expr_48E, this._foreArmTransform);
    expr_488.Components = expr_48E;
    var expr_4A6 = $S01().Construct();
    var expr_4AC = new ($T05())();
    var expr_4B2 = $S02().Construct();
    var expr_4B8 = new ($T01())();
    expr_4B8.Rotation = $S00().Construct(0, 0, 0);
    expr_4B8.Scale = $S00().Construct(1, 1, 1);
    expr_4B8.Translation = $S00().Construct(0, 4, 0);
    $S03().CallVirtual("Add", null, expr_4B2, expr_4B8);
    var expr_512 = new ($T07())();
    var expr_518 = new ($T08())();
    expr_518.Color = $S00().Construct(0, 0, 1);
    expr_512.Diffuse = expr_518;
    var expr_53D = new ($T09())();
    expr_53D.Color = $S00().Construct(1, 1, 1);
    expr_53D.Shininess = 5;
    expr_512.Specular = expr_53D;
    $S03().CallVirtual("Add", null, expr_4B2, expr_512);
    $S03().CallVirtual("Add", null, expr_4B2, $T0A().CreateCuboid($S00().Construct(2, 10, 2)));
    expr_4AC.Components = expr_4B2;
    $S04().CallVirtual("Add", null, expr_4A6, expr_4AC);
    var expr_59E = new ($T05())();
    var expr_5A4 = $S02().Construct();
    $S03().CallVirtual("Add", null, expr_5A4, this._greifarm1Transform);
    expr_59E.Components = expr_5A4;
    var expr_5BC = $S01().Construct();
    var expr_5C2 = new ($T05())();
    var expr_5C8 = $S02().Construct();
    var expr_5CE = new ($T01())();
    expr_5CE.Rotation = $S00().Construct(0, 0, 0);
    expr_5CE.Scale = $S00().Construct(1, 1, 1);
    expr_5CE.Translation = $S00().Construct(0, 2, 0);
    $S03().CallVirtual("Add", null, expr_5C8, expr_5CE);
    var expr_628 = new ($T07())();
    var expr_62E = new ($T08())();
    expr_62E.Color = $S00().Construct(0.5, 0.5, 0.5);
    expr_628.Diffuse = expr_62E;
    var expr_653 = new ($T09())();
    expr_653.Color = $S00().Construct(1, 1, 1);
    expr_653.Shininess = 5;
    expr_628.Specular = expr_653;
    $S03().CallVirtual("Add", null, expr_5C8, expr_628);
    $S03().CallVirtual("Add", null, expr_5C8, $T0A().CreateCuboid($S00().Construct(0.5, 3, 0.5)));
    expr_5C2.Components = expr_5C8;
    $S04().CallVirtual("Add", null, expr_5BC, expr_5C2);
    expr_59E.Children = expr_5BC;
    $S04().CallVirtual("Add", null, expr_4A6, expr_59E);
    var expr_6BF = new ($T05())();
    var expr_6C5 = $S02().Construct();
    $S03().CallVirtual("Add", null, expr_6C5, this._greifarm2Transform);
    expr_6BF.Components = expr_6C5;
    var expr_6DD = $S01().Construct();
    var expr_6E3 = new ($T05())();
    var expr_6E9 = $S02().Construct();
    var expr_6EF = new ($T01())();
    expr_6EF.Rotation = $S00().Construct(0, 0, 0);
    expr_6EF.Scale = $S00().Construct(1, 1, 1);
    expr_6EF.Translation = $S00().Construct(0, 2, 0);
    $S03().CallVirtual("Add", null, expr_6E9, expr_6EF);
    var expr_749 = new ($T07())();
    var expr_74F = new ($T08())();
    expr_74F.Color = $S00().Construct(0.5, 0.5, 0.5);
    expr_749.Diffuse = expr_74F;
    var expr_774 = new ($T09())();
    expr_774.Color = $S00().Construct(1, 1, 1);
    expr_774.Shininess = 5;
    expr_749.Specular = expr_774;
    $S03().CallVirtual("Add", null, expr_6E9, expr_749);
    $S03().CallVirtual("Add", null, expr_6E9, $T0A().CreateCuboid($S00().Construct(0.5, 3, 0.5)));
    expr_6E3.Components = expr_6E9;
    $S04().CallVirtual("Add", null, expr_6DD, expr_6E3);
    expr_6BF.Children = expr_6DD;
    $S04().CallVirtual("Add", null, expr_4A6, expr_6BF);
    expr_488.Children = expr_4A6;
    $S04().CallVirtual("Add", null, expr_390, expr_488);
    expr_372.Children = expr_390;
    $S04().CallVirtual("Add", null, expr_36C, expr_372);
    expr_2CD.Children = expr_36C;
    $S04().CallVirtual("Add", null, expr_222, expr_2CD);
    expr_21C.Children = expr_222;
    return expr_21C;
  }; 
  ...
  function HierarchyInput_RenderAFrame () {
    ...
    bodyRot += +$T0F().get_DeltaTime() * +$T11().get_Keyboard().get_LeftRightAxis();
    this._bodyTransform.Rotation = $S00().Construct(0, bodyRot, 0);
    var upperArmRot = +this._upperArmTransform.Rotation.x;
    upperArmRot += +$T0F().get_DeltaTime() * +$T11().get_Keyboard().get_UpDownAxis();
    this._upperArmTransform.Rotation = $S00().Construct(upperArmRot, 0, 0);
    var foreArmRot = +this._foreArmTransform.Rotation.x;
    foreArmRot += +$T0F().get_DeltaTime() * +$T11().get_Keyboard().get_WSAxis();
    this._foreArmTransform.Rotation = $S00().Construct(foreArmRot, 0, 0);
    var greifarm = +this._greifarm1Transform.Rotation.x;
    var greifarm2 = +this._greifarm2Transform.Rotation.x;
    var flag = $T11().get_Keyboard().IsKeyDown($T13().A);
    if (flag) {
      if ((+this._greifarm1Transform.Rotation.x >= 0) && (+this._greifarm1Transform.Rotation.x < 0.1)) {
        greifarm += 0.1;
        this._greifarm1Transform.Rotation = $S00().Construct(greifarm, 0, 0);
        greifarm2 += -0.1;
        this._greifarm2Transform.Rotation = $S00().Construct(greifarm2, 0, 0);
      }
    }
    var flag3 = $T11().get_Keyboard().IsKeyDown($T13().D);
    if (flag3) {
      if ((+this._greifarm1Transform.Rotation.x <= 0.11) && (+this._greifarm1Transform.Rotation.x > 0)) {
        greifarm += -0.1;
        this._greifarm1Transform.Rotation = $S00().Construct(greifarm, 0, 0);
        greifarm2 += 0.1;
        this._greifarm2Transform.Rotation = $S00().Construct(greifarm2, 0, 0);
    ...
    if (leftButton) {
      this._camAngle = +this._camAngle + (0.1 * +$T11().get_Mouse().get_Velocity().x);
    }
    (this.RenderCanvas$RC$value).Clear($T15().$Flags("Color", "Depth"));
    (this.RenderCanvas$RC$value.View = $S07().CallStatic($T16(), "op_Multiply", null, 
        $T16().CreateTranslation(0, -10, 50).MemberwiseClone(), 
        $T16().CreateRotationY(this._camAngle).MemberwiseClone()
      ).MemberwiseClone());
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false}, "_greifarm1Transform", $asm08.TypeRef("Fusee.Serialization.TransformComponent"));

    $.Field({Static:false, Public:false}, "_greifarm2Transform", $asm08.TypeRef("Fusee.Serialization.TransformComponent"));
